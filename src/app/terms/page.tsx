        ...
        <div className="max-w-screen-md mx-auto px-4">
          <div className="flex flex-col items-center text-center mb-6 space-y-2">
            <div className="h-10 w-10 bg-[#00AA5B]/10 rounded-xl flex items-center justify-center">
              <Scale className="w-5 h-5 text-[#00AA5B]" />
            </div>
            <h1 className="text-lg md:text-xl font-black font-headline tracking-tight">Syarat & Ketentuan</h1>
            ...
            <CardContent className="p-5 md:p-8 space-y-5">
              <section className="space-y-2.5">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xs md:text-sm font-bold">1. Penerimaan Ketentuan</h2>
                </div>
              ...
              <section className="space-y-2.5">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xs md:text-sm font-bold">2. Penggunaan Layanan</h2>
                </div>
                <div className="pl-9 space-y-2 text-[10px] md:text-[11px] leading-relaxed text-muted-foreground font-medium">
              ...
              <section className="space-y-2.5">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xs md:text-sm font-bold">3. Pembatalan & Pengembalian</h2>
                </div>
                <div className="pl-9 space-y-2 text-[10px] md:text-[11px] leading-relaxed text-muted-foreground font-medium">
              ...
              <section className="space-y-2.5">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xs md:text-sm font-bold">4. Hukum yang Berlaku</h2>
                </div>
                <div className="pl-9 space-y-2 text-[10px] md:text-[11px] leading-relaxed text-muted-foreground font-medium">
