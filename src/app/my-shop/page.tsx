    ...
    <main className="flex-1 p-3 md:p-6 lg:p-8">
      <div className="max-w-screen-xl mx-auto space-y-4">
        ...
        <Card className="border-none shadow-sm rounded-xl overflow-hidden bg-white">
          <div className="relative h-24 md:h-32 bg-muted/30">
            {shop.bannerUrl ? (
              ...
              <div className="absolute inset-0 bg-[#00AA5B]/5 flex items-center justify-center">
                <Store className="w-8 h-8 text-[#00AA5B] opacity-10" />
              </div>
            )}
            ...
            <div className="absolute bottom-3 left-4 right-4 flex items-end justify-between text-white">
              <div className="flex items-center gap-3">
                <div className="h-12 w-12 md:h-14 md:w-14 rounded-xl bg-white p-0.5 shadow-lg overflow-hidden relative border border-white/20">
                  {shop.logoUrl ? (
                    ...
                    <div className="w-full h-full bg-[#00AA5B] flex items-center justify-center rounded-lg">
                      <span className="text-lg font-black">{shop.name?.substring(0, 1) || "?"}</span>
                    </div>
                  )}
                </div>
                <div className="pb-0.5">
                  <h2 className="text-base font-bold tracking-tight leading-tight">{shop.name}</h2>
